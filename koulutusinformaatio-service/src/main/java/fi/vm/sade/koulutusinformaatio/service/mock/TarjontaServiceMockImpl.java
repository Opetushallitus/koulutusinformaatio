...
public class TarjontaServiceMockImpl implements TarjontaService {
    ...
    private ParentLOS createParentLOS() {
        ...
        parentLOS.setName(createI18nText("Audiovisuaalisen viestinnän perustutkinto", "Audiovis. viestinnän perustutk."));
        ...
        parentLOS.setEducationDomain(createI18nText("Kulttuuriala", "Kulttuuriala"));
        parentLOS.setStydyDomain(createI18nText("Viestintä ja informaatiotieteet", "Viestintä ja informaatiotieteet"));
        parentLOS.setEducationDegree("32");
        parentLOS.setCreditValue("120");
        parentLOS.setCreditUnit(createI18nText("opintoviikko", "ov"));
        return parentLOS;
    }
    ...
    private ChildLearningOpportunity createChildLO() {
        ...
        childLO.setName(createI18nText("Audiovisuaalisen viestinnän koulutusohjelma, media-assistentti", "Audiovisuaalinen viestintä, media-assistentti"));
        childLO.setDegreeTitle(createI18nText("Audiovisuaalisen viestinnän koulutusohjelma, media-assistentti", "Audiovisuaalinen viestintä, media-assistentti"));
        childLO.setQualification(createI18nText("Media-assistentti", "Media-assistentti"));
        ...
        childLO.setFormOfEducation(Lists.newArrayList(createI18nText("Nuorten koulutus")));
        //childLO.setWebLinks();
    ...
    private ChildLORef createChildLORef() {
        ...
        childLORef.setName(createI18nText("Audiovisuaalisen viestinnän koulutusohjelma, media-assistentti", "Audiovisuaalinen viestintä, media-assistentti"));
        childLORef.setNameByTeachingLang("Audiovisuaalisen viestinnän koulutusohjelma, media-assistentti");
        childLORef.setQualification(createI18nText("Media-assistentti", "Media-assistentti"));
