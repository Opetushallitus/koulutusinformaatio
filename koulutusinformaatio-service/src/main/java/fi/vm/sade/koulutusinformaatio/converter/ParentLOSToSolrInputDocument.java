...
public class ParentLOSToSolrInputDocument implements Converter<ParentLOS, List<SolrInputDocument>> {
    ...
    private SolrInputDocument createParentDoc(ParentLOS parent, Code prerequisite) {
        ...
        if (teachLang.equals("fi")) {
            ...
            doc.addField(LearningOpportunity.STUDY_DOMAIN, SolrUtil.resolveTextWithFallback("fi", parent.getStydyDomain().getTranslations()));
            ...
            doc.addField(LearningOpportunity.STUDY_DOMAIN, SolrUtil.resolveTextWithFallback("sv", parent.getStydyDomain().getTranslations()));
            ...
            doc.addField(LearningOpportunity.STUDY_DOMAIN, SolrUtil.resolveTextWithFallback("en", parent.getStydyDomain().getTranslations()));
        } else {
            ...
            doc.addField(LearningOpportunity.STUDY_DOMAIN, SolrUtil.resolveTranslationInTeachingLangUseFallback(parent.getTeachingLanguages(), parent.getEducationDomain().getTranslations()));
        }
