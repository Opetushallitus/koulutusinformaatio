...
public class ProviderNameFirstCharactersQuery extends SolrQuery {
    ...
    private final static String STARTS_WITH_FI = "startsWith_fi";
    private final static String STARTS_WITH_SV = "startsWith_sv";
    ...
    private static String resolveStartsWithFieldName(String lang) {
        if (lang.equalsIgnoreCase("sv")) {
            return STARTS_WITH_SV;
        }
        else {
            return STARTS_WITH_FI;
        }
    }
}
