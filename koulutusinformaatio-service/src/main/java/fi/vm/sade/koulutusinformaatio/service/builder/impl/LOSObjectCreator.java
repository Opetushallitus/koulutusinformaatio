...
public class LOSObjectCreator extends ObjectCreator {
    ...
    public HigherEducationLOS createHigherEducationLOS(KoulutusKorkeakouluV1RDTO koulutus, boolean checkStatus)
        ...
        boolean existsValidHakukohde = existsValidHakukohde(los, checkStatus);
...
//        los.setDegreeTitles(getI18nTextMultiple(koulutus.getTutkintonimikes())); // ei löydy KoulutusLukioV1RDTO:lle
    ...
    private boolean existsValidHakukohde(StandaloneLOS los, boolean checkStatus) throws KoodistoException {
    ...
    private <S extends KoulutusGenericV1RDTO, T extends StandaloneLOS> void addStandaloneLOSFields(S koulutus, T los, boolean checkStatus, String aoType)
        ...
        // If we are not fetching for preview, an exception is thrown if no valid application options exist
        if (checkStatus && !existsValidHakukohde(los, checkStatus)) {
            throw new TarjontaParseException("No valid application options for education: " + los.getId());
        }
        if (los.getApplicationOptions() != null) {
            for (ApplicationOption ao : los.getApplicationOptions()) {
        ...
        // los.setAdditionalProviders(List<Provider>);
        // los.setApplicationOptions(List<ApplicationOption>);
        // los.setAvailableTranslationLanguages(List<Code>);
        // los.setCareerOpportunities(I18nText);
        // los.setContactPersons(List<ContactPerson>);
        // los.setContent(I18nText);
        // los.setCooperation(I18nText);
        // los.setCreditUnit(I18nText);
        // los.setCreditValue(String);
        // los.setDegree(I18nText);
        // los.setDegreeTitle(I18nText);
        // los.setDegreeTitles(List<I18nText>);
        // los.setEducationCode(Code);
        // los.setEducationDegree(String);
        // los.setEducationDegreeLang(I18nText);
        // los.setEducationDomain(I18nText);
        // los.setEducationType(String);
        // los.setFacetPrerequisites(List<Code>);
        // los.setFormOfStudyFacet(List<Code>);
        // los.setFormOfTeaching(List<I18nText>);
        // los.setFotFacet(List<Code>);
        // los.setGoals(I18nText);
        // los.setId(String);
        // los.setInfoAboutCharge(I18nText);
        // los.setInternationalization(I18nText);
        // los.setKomoOid(String);
        // los.setKoulutuskoodi(I18nText);
        // los.setKoulutuslaji(Code);
        // los.setPduCodeUri(String);
        // los.setPlannedDuration(String);
        // los.setPlannedDurationUnit(I18nText);
        // los.setPrerequisites(List<Code>);
        // los.setProvider(Provider);
        // los.setQualifications(List<I18nText>);
        // los.setStartDate(Date);
        // los.setStartSeason(I18nText);
        // los.setStartYear(int);
        // los.setStatus(String);
        // los.setStructure(I18nText);
        // los.setTargetGroup(I18nText);
        // los.setTeachingLanguages(List<Code>);
        // los.setTeachingPlaces(List<I18nText>);
        // los.setTeachingTimes(List<I18nText>);
        // los.setTimeOfTeachingFacet(List<Code>);
    }
