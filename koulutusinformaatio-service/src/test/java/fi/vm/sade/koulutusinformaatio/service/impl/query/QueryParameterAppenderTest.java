...
public class QueryParameterAppenderTest {

    private SolrQuery solrQuery = new SolrQuery();
    QueryParameterAppender queryParameterAppender = new QueryParameterAppender();
    ...
    public void testMultipleFields() throws Exception {
        queryParameterAppender = new QueryParameterAppender();
        Map.Entry<String, List<String>> entryWithValue = MapEntryUtil.createEntryWithValue("test", "test2");
        queryParameterAppender.append(solrQuery, entryWithValue);
        assertEquals("+test:(test +test2) ", solrQuery.getQuery());
    }
}
