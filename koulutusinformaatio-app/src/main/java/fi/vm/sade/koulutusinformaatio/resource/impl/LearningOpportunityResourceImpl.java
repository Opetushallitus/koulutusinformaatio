...
public class LearningOpportunityResourceImpl implements LearningOpportunityResource {
    ...
    public LOSearchResultListDTO searchLearningOpportunities(String text, String prerequisite, 
            List<String> cities, List<String> facetFilters, List<String> articleFilters, String lang, boolean ongoing, 
            boolean upcoming, int start, int rows, String sort, String order, String lopFilter, String educationCodeFilter,
        ...
        try {
            ...
            LOSearchResultList learningOpportunities = searchService.searchLearningOpportunities(key, prerequisite,
                    cities, facetFilters, articleFilters, lang, ongoing, upcoming, start, rows, sort, order, 
