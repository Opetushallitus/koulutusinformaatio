...
public class AdultUpperSecondaryLOSToDTO {
    
    public AdultUpperSecondaryLOSToDTO() {
        
    }

    public static AdultUpperSecondaryLOSDTO convert(
            final AdultUpperSecondaryLOS los, final String lang, final String uiLang) {
        AdultUpperSecondaryLOSDTO dto =
                new AdultUpperSecondaryLOSDTO();
