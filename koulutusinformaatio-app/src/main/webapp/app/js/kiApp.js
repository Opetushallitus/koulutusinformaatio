...
kiApp.config(['$routeProvider', '$locationProvider', '$analyticsProvider', function($routeProvider, $locationProvider, $analyticsProvider) {
...
kiApp.run(['LanguageService', function(LanguageService) {
    ...
    (function() {
        var u=(("https:" == document.location.protocol) ? "https" : "https") + "://nat-piwik-poc.oph.ware.fi/analytics/";
