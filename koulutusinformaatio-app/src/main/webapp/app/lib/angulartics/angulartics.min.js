...
.provider('$analytics', function () {
  ...
  var bufferedSiteSearchTrack = function(keyword, category, resultCount) {
  	cache.sitesearches.push({keyword: keyword, category: category, resultCount: resultCount});
  }
  ...
  var registerSiteSearchTrack = function (fn) {
    ...
    angular.forEach(cache.events, function (keyword, category, resultCount) {
      setTimeout(function () { api.siteSearchTrack(keyword, category, resultCount); }, index * settings.siteSearchTracking.bufferFlushDelay);
    });
  };
