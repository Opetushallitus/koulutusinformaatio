...
//        childLOIRefs.add(createChildLORef(createI18Text("c1"), "c1 fi", "as123", "lo123", prerequisite));
//        childLOIRefs.add(createChildLORef(createI18Text("c2"), "c2 fi", "as123", "lo124", prerequisite));
//        childLOIRefs.add(createChildLORef(createI18Text("c3"), "c3 fi", "as124", "lo125", prerequisite));
//
...
//                parentLO.getProvider(), new Date(), 100, 25,6, 77, childLOIRefs, "32",
//                prerequisite));
...
//        childLO.setRelated(childLOIRefs);
//        Code c = new Code();
//        c.setValue("fi");
...
//        ChildLearningOpportunitySpecificationDTO result = learningOpportunityService.getChildLearningOpportunity("clo123", "en");
//        checkResult("en", result);
//    }
//
...
//    }
//
//    private ChildLOIRef createChildLORef(I18nText name, String nameByTeachingLang, String asId, String loId, Code prerequisite) {
